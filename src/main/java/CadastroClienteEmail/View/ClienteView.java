//package CadastroClienteEmail.View;
//
//import main.java.CadastroClienteEmail.Controller.ClienteController;
//import main.java.CadastroClienteEmail.Model.Cliente;
//
...
//    //solicitar a criação do contato para o controller
...
//            System.out.printf("id: %s - name: %s - Email : %s - phone: %s \n", cliente.getId(), cliente.getName(), cliente.getEmail(), cliente.getPhone());
//        }
//    }else{
...
//            }
//        }else{
//            System.out.println("Nã existem clientes cadastrados com o nome informado ");
//        }
//    }
//
...
//    String phone = terminal.nextLine();
//    //solicitar a atualização do contato para o controller
//    boolean ok = controller.updateClientes(code,name,email,phone);
//    if(ok){
//        System.out.println("Cadastro atualizado com sucesso");
//    }else{
//        System.out.println("Não foi possivel atualizar o cadastro");
//    }
//}
...
//    String code = terminal.nextLine();
//    //solicitar a remoção do contado para o controller
//    boolean ok = controller.removeClientes(code);
//    if(ok){
